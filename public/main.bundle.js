...
module.exports = "<app-navbar>Loading Navbar...</app-navbar>\n\n\n\n<div class=\"container\">\n  <flash-messages></flash-messages>\n  <router-outlet></router-outlet>\n</div>\n"
...
// to protect certain routes, we use our AuthGuard
var appRoutes = [
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_14__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]],
...
var RegisterComponent = (function () {
    // Every time we import a service, we need to inject it into the constructor
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(user)) {
            // this.flashMessage.show takes two arguments: message string and an options object, which helps us add an class and set a timeout for how long we want the message to be visible
...
var __metadata = (this && this.__metadata) || function (k, v) {
 ...
 // we need the map operator when working with observables
...
var AuthService = (function () {
    ...
    AuthService.prototype.storeUserData = function (token, user) {
        localStorage.setItem('id_token', token); //jwt, by default looks for that path
        // because localStorage can only store strings, and not objects
        // we turn the object into a string so it can be stored
